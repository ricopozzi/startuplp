...
export const InvestorContact: React.FC<any> = () => {
  ...
  return (
    <motion.div initial={{ scale: 0.7 }} animate={{ scale: 1 }}>
      <form
        ...
        className="w-full md:w-[32rem] h-96 md:h-auto p-4 flex flex-col justify-center bg-white border shadow-md rounded-lg relative"
      >
        <X
        ...
        />
        <div className="mb-3">
          <p className="font-medium text-lg">Quero investir</p>
